...
extern void set_server_operator_pwd(int server_index, char *pwd);
extern void clear_server_operator_pwd(int server_index);
extern	void	clear_all_server_operator_pwd(void);
extern void set_server_operator_nick(int server_index, char *nick);
